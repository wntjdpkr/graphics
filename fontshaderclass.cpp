...
bool FontShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"./data/fontShader.hlsl");
	if(!result)
	{
		return false;
	}
...
bool FontShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, const WCHAR* fileName)
{
	HRESULT result;
	...
	result = D3DCompileFromFile(fileName, NULL, NULL, "FontVertexShader", "vs_5_0", 
	...
	result = D3DCompileFromFile(fileName, NULL, NULL, "FontPixelShader", "ps_5_0", 
